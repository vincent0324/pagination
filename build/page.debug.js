...
var _juicer = __webpack_require__(2);
...
var tpl = ['{@if maxShowPage>1}', '<div class="dd-global-pagination">', '{@if pageCurrent>1}', '<a href="javascript:;" class="page-item j-page page-prev" data-page="${+pageCurrent-1}"><</a>', '{@/if}', '{@each pages as item,index}', '{@if item.type=="link"}', '<a href="javascript:;" class="page-item j-page" data-page="${item.value}">${item.value}</a>', '{@else if item.type=="plain"}', '<span class="page-current">${item.value}</span>', '{@else}', '<span class="page-ellipsis">...</span>', '{@/if}', '{@/each}', '{@if pageCurrent < maxShowPage}', '<a href="javascript:;" class="page-item j-page page-next" data-page="${+pageCurrent+1}">></a>', '{@/if}', '</div>', '{@/if}'];
var pages = [];
var SHOW_MAX = 9;
var SHOW_MIN = 3;
...
var Pagination = function () {
    ...
    _createClass(Pagination, [{
        key: 'generate',
        value: function generate(pageCurrent) {
            ...
            if (this.pageMax < SHOW_MAX) {
                ...
                if (+pageCurrent - 1 - 1 <= SHOW_MIN) {
                    ...
                    for (var ii = +pageCurrent - SHOW_MIN; ii <= +pageCurrent + SHOW_MIN; ii++) {
                        pages.push({
                            value: ii,
                            type: ii === +pageCurrent ? 'plain' : 'link'
                        });
                    }
        ...
        key: 'render',
        value: function render(pageMax, pageCurrent, maxShowPage) {
            var context = this;
            ...
            pageHtml = (0, _juicer2.default)(tpl.join(''), {
...
var _Pagination = __webpack_require__(0);

var _Pagination2 = _interopRequireDefault(_Pagination);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var page = new _Pagination2.default();

(0, _jquery2.default)('#page').html(page.render(30, 20, 5));
